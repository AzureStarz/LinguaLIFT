...
from .processors.la_align import preprocess_la_align_dataset, print_la_align_dataset_example
...
def get_preprocess_and_print_func(
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "kto", "lb", "ved_align", "la_align"],
    template: "Template",
    ...
    if stage == "pt":
        ...
        print_function = partial(print_la_align_dataset_example, tokenizer=tokenizer, encoder_tokenizer=encoder_tokenizer)
