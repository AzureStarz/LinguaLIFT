...
class ModelArguments(QuantizationArguments, ProcessorArguments, ExportArguments, VllmArguments):
    ...
    ### Additional Hparams
    exp_run_name: Optional[str] = field(
        default='debug',
        metadata={
            "help": "exp run name"
        },
    )
    lm_name_or_path: Optional[str] = field(
        default=None,
        metadata={
            "help": "Path to the llm"
        },
    )
    enc_name_or_path: Optional[str] = field(
        default=None,
        metadata={
            "help": "Path to the encoder model"
        },
    )
    alignments: Optional[str] = field(
        default='linear',
        metadata={
            "help": "the type of alignment module"
        },
    )
    enc_hidden_size: Optional[int] = field(
        default=None,
        metadata={"help": "The dim of encoder hidden states."},
    )
    lm_hidden_size: Optional[int] = field(
        default=None,
        metadata={"help": "The dim of llm hidden states."},
    )
    freeze_language_model: bool = field(
        default=True,
        metadata={"help": "Freeze llm or not"},
    )
    freeze_encoder: bool = field(
        default=True,
        metadata={"help": "Freeze encoder or not"},
    )
    freeze_alignment: bool = field(
        default=True,
        metadata={"help": "Freeze alignment module or not"},
    )
    add_new_lines_to_enc: bool = field(
        default=True,
