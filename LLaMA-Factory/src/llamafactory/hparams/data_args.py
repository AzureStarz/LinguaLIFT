...
class DataArguments:
    ...
    ### Additional Hparams
    max_length_enc: int = field(
        default=1024,
        metadata={"help": "The maximum length of the tokenized encoder inputs in the dataset."},
    )
    max_length_lm: int = field(
        default=256,
        metadata={"help": "The maximum length of the tokenized llm outputs in the dataset."},
    )
